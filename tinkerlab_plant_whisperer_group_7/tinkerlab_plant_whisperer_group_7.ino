...
const char* ssid = "OnePlus";                              //Stores your WiFi SSID (network name).
const char* password = "Geosense123";                      //Stores the WiFi password.
const char* server = "https://api.thingspeak.com/update";  //URL to send sensor data to ThingSpeak.
String apiKey = "AG2Y47H4KAIWJBMZ";                        //Your ThingSpeak write API key for uploading data.
